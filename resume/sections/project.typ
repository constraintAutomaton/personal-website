...
#project(name: "Patients triage with combinatorial optimization methods (Combinatorial Optimization, IFT-7020)")
...
#project(name: "Code analysis with z3 (Security and Formal Method, IFT-7010)")
...
#project(name: "Epicurean Cycling (Advanced Database, GLO-7035)")
...
#project(name: "Remote-controlled car")
...
#project(name: "Distance sensors with laser and camera")
